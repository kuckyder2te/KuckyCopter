...
In myLogger.h wird "#if defined LOCAL_DEBUG || defined GLOBAL_DEBUG" eingefügt und in Platformio.ini mit "-DGLOBAL_DEBUG" ausgewählt ob alle Dateien, oder nur spezielle debugt werden.
Man kann 
